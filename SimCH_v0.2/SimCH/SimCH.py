...
def NBzero_mean_dispersion():
    ...
    k3 = len(ls4p)//100
    s = np.array(ls7)
    print('Estimating mean and dispersion...')
    for i in range(len(ls4p)):
        if i%k3 == 0:
...
def BCV():
    ...
    -------
    param[19:24]:list
          Relationship parameters of mean and dispersion [t1, t2, t3, phi_0] and Degrees of freedom
    """
...
def write():
    ...
    if mod == '-a':
        ...
        f.write('\n')
        f.write('-6     '+'Relationship parameters of mean and dispersion [t1, t2, t3, phi_0]:{} '.format(param[19:23]))
        f.write('\n')
        f.write('-7     '+'Degrees of freedom:{}'.format(param[23]))
        f.write('\n')
        ...
        f.write('\n')
        f.write('-11    '+'Number of paths:{}'.format(param[30]))
        f.write('\n')
        f.write('-12    '+'DEgene ratio:{}'.format(param[28]))
        f.write('\n')
        f.write('-13    '+'DEgene variation:{}'.format(param[29]))
        f.write('\n')
        f.write('-14    '+'Non-linear genes ratio:{}'.format(param[31]))
        f.write('\n')
        ...
        f.write('\n')
        f.write('-7     '+'Relationship parameters of mean and dispersion [t1, t2, t3, phi_0]:{} '.format(param[19:23]))
        f.write('\n')
        f.write('-8     '+'Degrees of freedom:{}'.format(param[23]))
        f.write('\n')
        ...
        f.write('\n')
        f.write('-12    '+'Number of paths:{}'.format(param[30]))
        f.write('\n')
        f.write('-13    '+'DEgene ratio:{}'.format(param[28]))
        f.write('\n')
        f.write('-14    '+'DEgene variation:{}'.format(param[29]))
        f.write('\n')
        f.write('-15    '+'Non-linear genes ratio:{}'.format(param[31]))
        f.write('\n')
    ...
    if param[30] != 0:
        ...
        global lnorl,lnorla
        if len(lnorl) > 0:
            f8 = open(path2+'/Nonlinear gene factor','w')
            for i in range(param[2]):
                f8.write('\t')
                f8.write('cell'+str(i+1))
            f8.write('\n')
...
def NBzero_mean_dispersion_noparam():
    """
    Estimating mean and dispersion of -d or -d nocopula
    ...
    k1 = 0
    s = np.array(ls7)
    print('Estimating mean,dispersion,γ,ε...')
    k3 = len(ls4p)//100
    kk = 0
    warnings.filterwarnings("ignore")
    for i in range(len(ls4p)):
...
def mean_noparam():
    """
    Estimating mean and dispersion of -c or -c nocopula
...
def write_noparam():
    ...
    if mod == '-c':
        ...
        f.write('\n')
        f.write('-7\tNon-linear genes ratio:'+str(param_noline))
        f.write('\n')
    ...
    if param_group != [1]:
        if param_path == 'No':
            ...
            f = open(path3+'/Nonlinear gene factor.txt','w')
            for i in range(len(ls7_1)):
                f.write('\t')
                if cell_number == len(ls7):
                    f.write(str(ls[0][i]))
...
def NBzero_mean_dispersion_noparam_t():
    """
    Estimating mean and dispersion of -f or -f nocopula
...
while 1:
    ...
    print("Version:\tv0.2")
    print("Authors:\tGongming Wang, Lei Sun")
    ...
    if mod == '-a' or mod == '-b' or mod == '-c' or mod == '-c nocopula' or mod == '-d' or mod == '-d nocopula' or mod == '-e' or mod == '-e nocopula' or mod == '-f' or '-f nocopula' or ' ' or '-g':
        ...
        if mod == '-a':
            ...
            print('-6     '+'Relationship parameters of mean and dispersion [t1, t2, t3, phi_0]:{} '.format(param[19:23]))
            print('-7     '+'Degrees of freedom:{}'.format(param[23]))
            print('-8     '+'Group ratio (for extended simulation):{}'.format(param[27]))
            print('-9     '+'Batch ratio (for extended simulation):{}'.format(param[25]))
            print('-10    '+'Batch variation (for extended simulation, [mean, variance]):{}'.format(param[26]))
            print('-11    '+'Number of paths (for extended simulation):{}'.format(param[30]))
            print('-12    '+'DE genes ratio (for extended simulation):{}'.format(param[28]))
            print('-13    '+'DE genes variation (for extended simulation, [mean, variance]):{}'.format(param[29]))
            print('-14    '+'Non-linear genes ratio (for extended simulation):{}'.format(param[31]))
            print('-15    '+'Marker genes ratio (for extended simulation):{}'.format(param[32]))
            print('-16    '+'Library magnification (for setting sequencing depth):{}'.format(param[33]))
            ...
            while 1:
                ...
                if mod1 == '-s' or mod1 == '-v' or mod1 == '-1' or mod1 == '-2' or mod1 == '-3' or mod1 == '-4' or mod1 == '-5' or mod1 == '-6' or mod1 == '-7' or mod1 == '-8' or mod1 == '-9' or mod1 == '-10' or mod1 == '-11' or mod1 == '-12' or mod1 == '-13' or mod1 == '14':
                    ...
                    if mod1 == '-s':
                        ...
                        mod2 = input('Please input new Relationship parameters of mean and dispersion [t1, t2, t3, phi_0]: ')
                        try:
                            a = mod2[1:-1].strip().split(',')
                            b = [float(i) for i in a]
                            param[19:23] = b
                        ...
                        mod2 = input('Please input new Degrees of freedom: ')
                        try:
                            a = int(mod2)
                            param[23] = a
                        except:
                        ...
                        mod2 = input('Please input new Number of paths: ')
                        try:
                            a = int(mod2)
                            param[30] = a
                        except:
                        ...
                        mod2 = input('Please input new Non-linear genes ratio: ')
                        try:
                            a = float(mod2)
                            param[31] = a
                        except:
            ...
            print('-7     '+'Relationship parameters of mean and dispersion [t1, t2, t3, phi_0]:{} '.format(param[19:23]))
            print('-8     '+'Degrees of freedom:{}'.format(param[23]))
            print('-9     '+'Group ratio (for extended simulation):{}'.format(param[27]))
            print('-10    '+'Batch (for extended simulation):{}'.format(param[25]))
            print('-11    '+'Batch variation (for extended simulation, [mean, variance]):{}'.format(param[26]))
            print('-12    '+'Number of paths (for extended simulation):{}'.format(param[30]))
            print('-13    '+'DE genes ratio (for extended simulation):{}'.format(param[28]))
            print('-14    '+'DE genes variation (for extended simulation, [mean, variance]):{}'.format(param[29]))
            print('-15    '+'Non-linear genes ratio (for extended simulation):{}'.format(param[31]))
            print('-16    '+'Marker genes ratio (for extended simulation):{}'.format(param[32]))
            print('-17    '+'Library magnification (for setting sequencing depth):{}'.format(param[33]))
            ...
            print('-3\tBatch variation (for extended simulation, [mean, variance]):'+str(param_batch_var)+int(24-len(str(param_batch_var)))*' ')
            print('-4\tPath (for extended simulation):'+str(param_path)+int(35-len(str(param_path)))*' ')
            print('-5\tDE genes ratio (for extended simulation):'+str(param_DEgene)+int(27-len(str(param_DEgene)))*' ')
            print('-6\tDE genes variation (for extended simulation, [mean, variance]):'+str(param_DEgene_var)+int(23-len(str(param_DEgene_var)))*' ')
            print('-7\tNon-linear genes ratio (for extended simulation):'+str(param_noline)+int(18-len(str(param_noline)))*' ')
            print('-8\tMarker genes ratio (for extended simulation):'+str(param_marker)+int(22-len(str(param_marker)))*' ')
            print('-9\tLibrary magnification (for setting sequencing depth):'+str(param_library)+int(18-len(str(param_library)))*' ')
            print('-10\tCell number:'+str(cell_number)+int(28-len(str(cell_number)))*' ')
            print('\n')
            print('If you want to modify the above parameters, please enter a number')
            print('-v means view current parameters')
            print('-s means start simulation')
            ...
            while 1:
                ...
                if a == '-1':
                    ...
                    while 1:
                        try:
                            a1 = input('Please input new Non-linear genes ratio: ')
                            b = float(a1)
                            if b >= 0 and b <= 1 and b+param_DEgene <= 1:
                                param_noline = b
                                break
                            else:
                                print('Non-linear genes ratio should be greater than 0 and less than 1')
                        except:
                            print('Format error, the input data should be a floating point number')
                    ...
                    if a1 != '-m':
                        ...
                        print('-7\tNon-linear genes ratio:'+str(param_noline))
            ...
            print('-3\tBatch variation (for extended simulation, [mean, variance]):'+str(param_batch_var))
            print('-4\tPath (for extended simulation):'+str(param_path))
            print('-5\tDE genes ratio (for extended simulation):'+str(param_DEgene))
            print('-6\tDE genes variation (for extended simulation, [mean, variance]):'+str(param_DEgene_var))
            print('-7\tNon-linear genes ratio (for extended simulation):'+str(param_noline))
            print('-8\tMarker genes ratio (for extended simulation):'+str(param_marker))
            print('-9\tLibrary magnification (for setting sequencing depth):'+str(param_library))
            print('-10\tCell number:'+str(cell_number))
            print('\n')
            print('If you want to modify the above parameters, please enter a number')
            print('-v means view current parameters')
